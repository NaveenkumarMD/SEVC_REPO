                    ...
                    [...Array(teammemberscount)].map((e, i) => {
                        ...
                        return (
                            <>
                                ...
                                <div className='input-container'>
                                    <label>Designation</label><br />
                                    <select value={teamDetails[i].designation} name="designation" defaultValue="team_member" onChange={(e) => teamdatachange(e, i)}>
                                        <option value="captain">Captain</option>
                                        <option value="vice_captain">Vice-Captain</option>
                                        <option value="production_head">Production Head</option>
                                        <option value="vehicle_quality_head">Vehicle Quality Head(VQH)</option>
...
const Phase1 = (props) => {
    ...
    const handlesubmit = async () => {
        if (data.transactionID && data.transactionID.length !== 12) {
            return message.error('Transaction ID must be present and be of 12 digits')
    ...
    return (
        ...
        >
            ...
            >
                <div className='input-container'>
                    <label>Transaction ID(must be of 12 digit UTR number/UPI transaction ID)</label><br />
                    <input
